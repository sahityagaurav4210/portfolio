...
function Experience({ experience }: Readonly<IExperienceProps>): ReactNode {
  return (
    <>
      <SimpleHeading headingName='Experience' className='mt-4 mb-1' />
      ...
      <section className='container mx-auto p-2'>
        <TextContainer>
          <p className='px-2 text-sm lg:text-lg my-2 font-roboto text-justify'>
            ...
            <span className='font-bold'>3</span> years of experience in software development. Following are my experience details in reverse
            chronological manner i.e., starting from latest to previous one. Please note that this section shows my overall work experience,
            for skill-wise experience, please visit{' '}
