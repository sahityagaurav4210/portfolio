      ...
      <div className='grid lg:grid-cols-3 text-zinc-200'>
        ...
        <div className="p-1 flex items-center justify-center lg:border-r flex-col">
          <div className='w-full px-1'>
            <p className='text-xs font-roboto font-bold italic'>External Links</p>
          </div>

          <div>
            <a href={import.meta.env.VITE_PBADMIN_URL} target='_blank' className='mx-1 underline decoration-dashed underline-offset-2'>Admin Panel</a>
            <a href="#" className='mx-1 underline decoration-dashed underline-offset-2'>CMS Portal</a>
          </div>
        </div>
